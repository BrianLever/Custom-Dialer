...
open class BaseConfig(val context: Context) {
    ...
    var textColor: Int
        get() = prefs.getInt(TEXT_COLOR, context.resources.getColor(R.color.md_grey_black_dark))
        set(textColor) = prefs.edit().putInt(TEXT_COLOR, textColor).apply()
    /* kinamdar */
    var backgroundColor: Int
     /*   get() = prefs.getInt(BACKGROUND_COLOR, context.resources.getColor(R.color.default_background_color)) */
        get() = prefs.getInt(BACKGROUND_COLOR, context.resources.getColor(R.color.md_grey_white))
        set(backgroundColor) = prefs.edit().putInt(BACKGROUND_COLOR, backgroundColor).apply()
/* kinamdar */
    var primaryColor: Int
    /*  get() = prefs.getInt(PRIMARY_COLOR, context.resources.getColor(R.color.color_primary)) */
        get() = prefs.getInt(PRIMARY_COLOR, context.resources.getColor(R.color.md_blue))
        set(primaryColor) = prefs.edit().putInt(PRIMARY_COLOR, primaryColor).apply()

    var cardViewColor:Int
    get() = prefs.getInt(CARD_VIEW_COLOR, context.resources.getColor(R.color.white_smoke))
    set(primaryColor) = prefs.edit().putInt(CARD_VIEW_COLOR, cardViewColor).apply()

    var accentColor: Int
     /*   get() = prefs.getInt(ACCENT_COLOR, context.resources.getColor(R.color.color_primary)) */
        get() = prefs.getInt(ACCENT_COLOR, context.resources.getColor(R.color.md_blue))
