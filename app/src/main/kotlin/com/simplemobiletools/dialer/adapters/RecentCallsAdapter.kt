...
import com.simplemobiletools.dialer.activities.ProfileActivity
...
//            R.id.cab_send_sms -> sendSMS()
  ...
  /*  private fun lauchrichcallholder() {

        activity.let{
            val richcallintent = Intent(it, richcallholder::class.java)
            val phoneNumber = getSelectedPhoneNumber() ?: return
            val sim = "three"
            richcallintent.putExtra("number", phoneNumber)
            richcallintent.putExtra("sim", sim)
            it?.startActivity(richcallintent)
        }
    } */

  /*  private fun launchrichcallholdersim(useSimOne: Boolean){
...
//            }
      ...
      /*      item_recents_duration.apply {
            ...
            imageRCDCall.apply{
                val bundle = Bundle()
                bundle.putString("callName", call.name)
                bundle.putString("callPhone",call.phoneNumber)
